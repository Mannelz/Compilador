...
public class Lexical
{
        ...
        try 
        {
            do
            {
                ...
                if(currentByte == '"')
                {
                    ...
                    symbol = new Symbol("CONST", "2", lexeme, SymbolClass.VARIABLE, SymbolType.STRING);
    ...
    public static void processLexeme(String lexeme)
    {
        ...
        {
            symbol = new Symbol("ID", "1", lexeme, SymbolClass.VARIABLE);
            token = Token.createToken(symbol, line, column);
        ...
        {
            symbol = new Symbol("CONST", "2", lexeme, SymbolClass.VARIABLE, SymbolType.INT);
            token = Token.createToken(symbol, line, column);
        ...
        {
            symbol = new Symbol("CONST", "2", lexeme, SymbolClass.VARIABLE, SymbolType.BYTE);
            token = Token.createToken(symbol, line, column);
